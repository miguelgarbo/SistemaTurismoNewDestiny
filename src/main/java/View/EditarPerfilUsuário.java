...
public class EditarPerfilUsuário extends JFrame {
    ...
    public EditarPerfilUsuário(UsuarioController usuarioController, PacoteController pacoteController, PasseioController passeioController, RoteiroController roteiroController) {
